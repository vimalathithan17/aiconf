  ...
  return (
    <div style={{ backgroundColor: '#023e8a', color: 'white', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ padding: '2rem' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: '#0096ff', color: 'white' }}>
          <thead>
            <tr style={{ backgroundColor: '#0077cc' }}>
              <th style={{ border: '2px solid white', padding: '1rem' }}>Event</th>
              <th style={{ border: '2px solid white', padding: '1rem' }}>Date</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style={{ border: '2px solid white', padding: '1rem' }}>Last date for paper submission</td>
              <td style={{ border: '2px solid white', padding: '1rem' }}>24 JULY 2025</td>
            </tr>
            <tr>
              <td style={{ border: '2px solid white', padding: '1rem' }}>Notification of paper acceptance</td>
              <td style={{ border: '2px solid white', padding: '1rem' }}>24 AUGUST 2025</td>
            </tr>
            <tr>
              <td style={{ border: '2px solid white', padding: '1rem' }}>Registration & Final Paper Submission</td>
              <td style={{ border: '2px solid white', padding: '1rem' }}>24 SEPTEMBER 2025</td>
            </tr>
          </tbody>
        </table>
      </div>
